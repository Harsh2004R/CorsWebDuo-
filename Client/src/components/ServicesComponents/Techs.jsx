...
const Techs = () => {
    const data = [
        ...
        {
            "img": "image/icon-8.jpg",
            "title": "Anime JS",
            "content": "Anime.js (/ˈæn.ə.meɪ/) is a lightweight JavaScript animation library with a simple, yet powerful API. It works with CSS properties, SVG, DOM attributes and JavaScript Objects...",
            "link": "#"
        }
    ]
